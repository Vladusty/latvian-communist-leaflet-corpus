...
The LCLC generally preserves the spelling found in the published edition. Only limited additional normalization has been introduced by the corpus compiler. In particular, the forms *tipografija*, *sociāldemokrats*, and *telegrafs* have been consistently rendered according to modern Latvian orthography as *tipogrāfija*, *sociāldemokrāts*, and *telegrāfs*, respectively.
