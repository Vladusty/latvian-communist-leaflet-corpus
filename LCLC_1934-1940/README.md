...
The LCLC generally preserves the spelling found in the published edition. Only limited additional normalization has been introduced by the corpus compiler. In particular, the forms *tipografija*, *sociāldemokrats*, *telegrafs*, *demokratija*, *krize*, *birokratisms*, *simpatija*, *baze*, *fraze*, *organs* and *muzika* have been consistently rendered according to modern Latvian orthography as *tipogrāfija*, *sociāldemokrāts*, *telegrāfs*, *demokrātija*, *krīze*, *birokrātisms*, *simpātija*, *bāze*, *frāze*, *orgāns* and *mūzika* respectively.
